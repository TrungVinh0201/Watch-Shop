            ...
            <div className="product_detail_info">
                ...
                <div className="detail_info">
                    ...
                    <div className='button_detail'>
                        <button className='btn_action'  onClick={() => handleAddToCart(singleProduct)}>Thêm vào giỏ hàng</button>
                        <button className='btn_action' onClick={() => handleBuyNow(singleProduct)}>Mua ngay</button>
                    </div>
                </div>
            </div>
